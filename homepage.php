...
<title>Welcome • HAPPY CHURCH</title>
...
<div class="home-container">
  ...
  <div class="hero-banner">
    ...
    <p class="welcome-subtitle">
      We are blessed to have you here at HAPPY CHURCH. Connect, grow, and manage your events efficiently.
    </p>
  ...
  <div class="cards-grid">
    ...
    <a href="events.php" class="nav-card green">
      ...
      <p class="nav-card-desc">
        Explore upcoming HAPPY CHURCH, service times, and special gatherings happening within the community.
      </p>
      <div class="nav-card-action">
